...
def merge_files(date: str) -> str:
    input_dir = f"data/raw/open_weather/{date}"
    output_path = "data/processed/open_weather/meteo_global.csv"
    ...
    upload_to_supabase(output_path, "data/processed/open_weather/meteo_global.csv")
